...
- [ ] [Add a remote](https://help.github.com/en/articles/adding-a-remote) called `upstream` pointing to this repo (`https://github.com/gallettilance/CS506-Spring2023` or `git@github.com:gallettilance/CS506-Spring2023.git`)
